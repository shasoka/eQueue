...
val pages = listOf(
    Page(
        ...
        description = "eQueue поможет вам и вашей группе следить за предстоящими лабораторными," +
    ...
    Page(
        title = "Приступим?",
        description = "Вы можете авторизоваться, используя учетные данные корпоративного " +
